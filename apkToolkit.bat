...
echo.
echo  The toolkit currently uses apktool_2.2.0.jar.
echo  To switch to a different apktool_2.0.X.jar version, just copy it into the 'tools' folder
echo  and rename it 'apktool.jar'
echo.
